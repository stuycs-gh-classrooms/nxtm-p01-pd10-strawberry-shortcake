...
- Instance variables:
	- PVector center; center of the alien
 	- int moveSpeed; alien movespeed
  	- int shootSpeed; shoot rate of the alien.
  	- boolean chocolateCovered; is the alien covered in chocolate? (a shield)
...
- class AlienBullet // strawberry seeds
 
- Instance variables:
	- int ySpeed; //speed of the alienBullet.
	- PVector head; // the head of the bullet.
 
- Constructor AlienBullet(PVector h, int speed)
	- Instantiates the ySpeed
	- Creates a new PVector storing the x and y values of the bullet's head.
